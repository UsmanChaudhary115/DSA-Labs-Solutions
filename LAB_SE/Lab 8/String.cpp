...
// Above are the friend functions
...
//ABove all are private functions
...
//{
//	String s = date.getDateInFormat1();
//	data = s.data;
//	size = s.size;
//}
String::~String()
...
{
	return (compare(ref) == 1) ? true : false;
}
bool String::operator<(const String& ref) const
{
	return (compare(ref) == -1) ? true : false;
...
bool String::operator==(const String& ref) const
{
	return (compare(ref) == 0) ? true : false;
